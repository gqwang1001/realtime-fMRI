...
static emlrtRSInfo j_emlrtRSI = { 43,  // lineNo
  ...
  "/Applications/MATLAB_R2020a.app/toolbox/eml/eml/+coder/+internal/indexShapeCheck.m"// pathName 
};

static emlrtRTEInfo g_emlrtRTEI = { 121,// lineNo
  5,                                   // colNo
  "errOrWarnIf",                       // fName
  "/Applications/MATLAB_R2020a.app/toolbox/eml/eml/+coder/+internal/indexShapeCheck.m"// pName 
};
