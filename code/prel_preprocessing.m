function [nuisX_comb,tform_old, volVec, volRaw] = prel_preprocessing(i, X, maskIDXs, volRaw, slice_times, slice_indices, tr, brainmask, tform_old, volVec, nuisX_comb, volumeoriginal, wm_csf_mask, motion_tol)
        volRaw(:,i) = X(maskIDXs);
        volVec_slc = rt_slice_time_correction(volRaw(:, 1:i), slice_times, slice_indices, tr, 0);
